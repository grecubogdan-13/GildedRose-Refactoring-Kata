...
describe('Gilded Rose new updateQuality2 random tests', () => {
...
describe('Gilded Rose new updateQuality2 standard item tests', () => {
...
describe('Gilded Rose new updateQuality2 sulfuras test', () => {
...
describe('Gilded Rose new updateQuality2 aged brie test', () => {
...
describe('Gilded Rose new updateQuality2 backstage pass test', () => {
...
describe('Gilded Rose new updateQuality2 conjured test', () => {
